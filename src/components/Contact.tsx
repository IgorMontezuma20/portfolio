...
export function Contact() {
  ...
  const contacts = [
    {
      name: "WhatsApp",
      description: "+55 32 9.8460-6012",
      link: "https://wa.me/5532984666012?text=Olá...",
      icon: <FaWhatsapp className="h-10 w-10" />,
    },
    {
      name: "Email",
      description: "igorminranda17@gmail.com",
      link: "mailto:igorminranda17@gmail.com?subject=Olá...",
      icon: <HiOutlineEnvelope className="h-10 w-10" />,
    },
    {
      name: "Carangola",
      description: "Triângulo",
      link: "https://goo.gl/maps/exxFnWHQTg5oZRKx9",
